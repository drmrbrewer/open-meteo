...
# ================================
# FROM ghcr.io/open-meteo/docker-container-build:0.0.10 AS build
#
...
# ================================
# FROM ghcr.io/open-meteo/docker-container-run:0.0.17
#
# MRB note to self: I have forked the above in case we need to modify and build our own image in future (no mods as yet)...
...
# COPY --from=build --chown=openmeteo:openmeteo /build/Resources /root/Resources
...
# Attach a volumne
#
# MRB removed "chown openmeteo:openmeteo" statement... need to do everything as root...
